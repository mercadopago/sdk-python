...
class PaymentPayer:
    ...
    Attributes:
        ...
        identification (dict): Identification document with type and number.
...
class PaymentRequest:
    ...
    Attributes:
        ...
        token (str): Card token generated by Mercado Pago SDK.
        payment_method_id (str): Payment method identifier (e.g., 'visa', 'master').
        installments (int): Number of installments.
        issuer_id (str): Card issuer identifier.
        payer (PaymentPayer, required): Payer information.
        capture (bool): Whether to auto-capture the payment (default: True).
        binary_mode (bool): Return only approved or rejected status (default: False).
        external_reference (str): External reference for the payment.
        statement_descriptor (str): Description that appears on card statement (max 22 chars).
        date_of_expiration (datetime): Expiration date for the payment.
        additional_info (PaymentAdditionalInfo): Additional payment information.
        application_fee (float): Fee amount for marketplace applications.
        notification_url (str): IPN notification URL (deprecated).
        callback_url (str): Callback URL after payment completion.
        coupon_code (str): Discount coupon code.
        coupon_amount (float): Discount amount from coupon.
    """
    pass
