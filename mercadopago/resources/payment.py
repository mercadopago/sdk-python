...
class PaymentPayer:
    ...
    Attributes:
        ...
        identification (dict): Payer's identification document.
        entity_type (str): Type of entity (individual or association).
    """
    pass
...
class PaymentRequest:
    ...
    Attributes:
        transaction_amount (float, required): Total transaction amount.
        token (str): Card token generated by MercadoPago.js.
        ...
        statement_descriptor (str): Statement descriptor (max 22 characters).
        ...
        callback_url (str): URL for callback after payment.
